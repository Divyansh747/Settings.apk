...
# direct methods
.method static synthetic -wrap0(Lcom/android/settings/location/DimmableIZatIconPreference;Z)V
    .locals 0
    .param p1, "dimmed"    # Z

    .prologue
    invoke-virtual {p0, p1}, Lcom/android/settings/location/DimmableIZatIconPreference;->dimIcon(Z)V
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 126
    invoke-direct {p0, p1, p2, p3, v3}, Lcom/android/settings/DimmableIconPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;ILjava/lang/CharSequence;)V

    .line 128
    sget-object v3, Lcom/android/settings/location/DimmableIZatIconPreference;->mLoader:Ldalvik/system/DexClassLoader;
    ...
    .line 130
    new-instance v5, Lcom/android/settings/location/DimmableIZatIconPreference$1;

    invoke-direct {v5, p0}, Lcom/android/settings/location/DimmableIZatIconPreference$1;-><init>(Lcom/android/settings/location/DimmableIZatIconPreference;)V
    ...
    :try_start_0
    sget-object v3, Lcom/android/settings/location/DimmableIZatIconPreference;->mGetXtProxyMethod:Ljava/lang/reflect/Method;
    ...
    sget-object v3, Lcom/android/settings/location/DimmableIZatIconPreference;->mGetConsentMethod:Ljava/lang/reflect/Method;
    ...
    iput-boolean v3, p0, Lcom/android/settings/location/DimmableIZatIconPreference;->mChecked:Z
    :try_end_0
...
.method private static load(Landroid/content/Context;)V
    ...
    .line 79
    sget-object v4, Lcom/android/settings/location/DimmableIZatIconPreference;->mNotifierClz:Ljava/lang/Class;
    ...
    .line 88
    .local v0, "e":Ljava/lang/Throwable;
    sput-object v6, Lcom/android/settings/location/DimmableIZatIconPreference;->mXtProxyClz:Ljava/lang/Class;

    .line 89
    sput-object v6, Lcom/android/settings/location/DimmableIZatIconPreference;->mNotifierClz:Ljava/lang/Class;

    .line 90
    sput-object v6, Lcom/android/settings/location/DimmableIZatIconPreference;->mIzatPackage:Ljava/lang/String;

    .line 91
    sput-object v6, Lcom/android/settings/location/DimmableIZatIconPreference;->mGetXtProxyMethod:Ljava/lang/reflect/Method;

    .line 92
    sput-object v6, Lcom/android/settings/location/DimmableIZatIconPreference;->mGetConsentMethod:Ljava/lang/reflect/Method;

    .line 93
    sput-object v6, Lcom/android/settings/location/DimmableIZatIconPreference;->mShowIzatMethod:Ljava/lang/reflect/Method;
...
.method public static newInstance(Landroid/content/Context;Ljava/lang/CharSequence;Lcom/android/settings/location/InjectedSetting;)Lcom/android/settings/DimmableIconPreference;
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
    ...
    .line 103
    invoke-direct {v0, p0, v2, v1}, Lcom/android/settings/location/DimmableIZatIconPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public onBindViewHolder(Landroid/support/v7/preference/PreferenceViewHolder;)V
    ...
    .line 159
    invoke-super {p0, p1}, Lcom/android/settings/DimmableIconPreference;->onBindViewHolder(Landroid/support/v7/preference/PreferenceViewHolder;)V

    .line 160
    invoke-virtual {p0}, Lcom/android/settings/location/DimmableIZatIconPreference;->isEnabled()Z

    move-result v1

    if-eqz v1, :cond_0

    iget-boolean v1, p0, Lcom/android/settings/location/DimmableIZatIconPreference;->mChecked:Z
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lcom/android/settings/location/DimmableIZatIconPreference;->dimIcon(Z)V
