...
.method private addServiceSetting(Ljava/util/List;Lcom/android/settings/location/InjectedSetting;)Landroid/support/v7/preference/Preference;
    .locals 8
    ...
    .line 280
    invoke-static {v5, v1, p2}, Lcom/android/settings/location/DimmableIZatIconPreference;->newInstance(Landroid/content/Context;Ljava/lang/CharSequence;Lcom/android/settings/location/InjectedSetting;)Lcom/android/settings/DimmableIconPreference;
...
.method private getSettings(Landroid/os/UserHandle;)Ljava/util/List;
    ...
    :try_start_0
    invoke-direct {p0, v5, p1, v3}, Lcom/android/settings/location/SettingsInjector;->parseServiceInfo(Landroid/content/pm/ResolveInfo;Landroid/os/UserHandle;Landroid/content/pm/PackageManager;)Lcom/android/settings/location/InjectedSetting;
...
.method private parseServiceInfo(Landroid/content/pm/ResolveInfo;Landroid/os/UserHandle;Landroid/content/pm/PackageManager;)Lcom/android/settings/location/InjectedSetting;
    ...
    invoke-static {v8, v9}, Lcom/android/settings/location/DimmableIZatIconPreference;->showIzat(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v8, v9, p2, v5, v1}, Lcom/android/settings/location/SettingsInjector;->parseAttributes(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;Landroid/content/res/Resources;Landroid/util/AttributeSet;)Lcom/android/settings/location/InjectedSetting;
    :try_end_2
...
.method public getInjectedSettings(I)Ljava/util/List;
    ...
    invoke-direct {p0, v2, v5}, Lcom/android/settings/location/SettingsInjector;->addServiceSetting(Ljava/util/List;Lcom/android/settings/location/InjectedSetting;)Landroid/support/v7/preference/Preference;
