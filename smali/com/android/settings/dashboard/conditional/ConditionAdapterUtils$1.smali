.class final Lcom/android/settings/dashboard/conditional/ConditionAdapterUtils$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/settings/dashboard/conditional/ConditionAdapterUtils;->addDismiss(Landroid/support/v7/widget/RecyclerView;)V
.end annotation
...
.method constructor <init>(IILandroid/support/v7/widget/RecyclerView;)V
    ...
    .prologue
    .line 36
    iput-object p3, p0, Lcom/android/settings/dashboard/conditional/ConditionAdapterUtils$1;->val$recyclerView:Landroid/support/v7/widget/RecyclerView;
...
.method public onSwiped(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    .prologue
    .line 52
    iget-object v2, p0, Lcom/android/settings/dashboard/conditional/ConditionAdapterUtils$1;->val$recyclerView:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView;->getAdapter()Landroid/support/v7/widget/RecyclerView$Adapter;

    move-result-object v0

    check-cast v0, Lcom/android/settings/dashboard/DashboardAdapter;

    .line 53
    .local v0, "adapter":Lcom/android/settings/dashboard/DashboardAdapter;
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getItemId()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lcom/android/settings/dashboard/DashboardAdapter;->getItem(J)Ljava/lang/Object;

    move-result-object v1

    .line 54
    .local v1, "item":Ljava/lang/Object;
    instance-of v2, v1, Lcom/android/settings/dashboard/conditional/Condition;
