...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/util/SortedMap;
    ...
    .line 204
    .local v2, "credentials":Ljava/util/SortedMap;, "Ljava/util/SortedMap<Ljava/lang/String;Lcom/android/settings/UserCredentialsSettings$Credential;>;"
    ...
    .line 206
    .local v4, "type":Lcom/android/settings/UserCredentialsSettings$Credential$Type;
    iget-object v5, v4, Lcom/android/settings/UserCredentialsSettings$Credential$Type;->prefix:Ljava/lang/String;
    ...
    .line 213
    .local v1, "c":Lcom/android/settings/UserCredentialsSettings$Credential;
    if-nez v1, :cond_2

    .line 214
    new-instance v1, Lcom/android/settings/UserCredentialsSettings$Credential;

    .end local v1    # "c":Lcom/android/settings/UserCredentialsSettings$Credential;
    invoke-direct {v1, v0}, Lcom/android/settings/UserCredentialsSettings$Credential;-><init>(Ljava/lang/String;)V

    .restart local v1    # "c":Lcom/android/settings/UserCredentialsSettings$Credential;
    invoke-interface {v2, v0, v1}, Ljava/util/SortedMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 216
    :cond_2
    iget-object v12, v1, Lcom/android/settings/UserCredentialsSettings$Credential;->storedTypes:Ljava/util/EnumSet;
    ...
    .line 219
    .end local v4    # "type":Lcom/android/settings/UserCredentialsSettings$Credential$Type;
    :cond_4
    return-object v2
.end method
...
.method protected onPostExecute(Ljava/util/SortedMap;)V
    ...
    new-instance v2, Lcom/android/settings/UserCredentialsSettings$CredentialAdapter;

    iget-object v0, p0, Lcom/android/settings/UserCredentialsSettings$AliasLoader;->this$0:Lcom/android/settings/UserCredentialsSettings;

    invoke-virtual {v0}, Lcom/android/settings/UserCredentialsSettings;->getContext()Landroid/content/Context;
    ...
    new-array v4, v4, [Lcom/android/settings/UserCredentialsSettings$Credential;
    ...
    invoke-direct {v2, v3, v4, v0}, Lcom/android/settings/UserCredentialsSettings$CredentialAdapter;-><init>(Landroid/content/Context;I[Lcom/android/settings/UserCredentialsSettings$Credential;)V
