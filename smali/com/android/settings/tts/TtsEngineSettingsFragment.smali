...
.field private mEngineSettingsPreference:Landroid/support/v7/preference/Preference;

.field private mEnginesHelper:Landroid/speech/tts/TtsEngines;

.field private mInstallVoicesPreference:Landroid/support/v7/preference/Preference;
...
# direct methods
.method static synthetic -get0(Lcom/android/settings/tts/TtsEngineSettingsFragment;)Landroid/support/v7/preference/ListPreference;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mLocalePreference:Landroid/support/v7/preference/ListPreference;
...
.method private setLocalePreference(I)V
    ...
    iget-object v1, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mLocalePreference:Landroid/support/v7/preference/ListPreference;
...
.method private updateDefaultLocalePref(Ljava/util/ArrayList;)V
    ...
    .line 238
    :cond_0
    iget-object v9, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mLocalePreference:Landroid/support/v7/preference/ListPreference;

    invoke-virtual {v9, v11}, Landroid/support/v7/preference/ListPreference;->setEnabled(Z)V
    ...
    invoke-virtual {v9, v1}, Landroid/support/v7/preference/ListPreference;->setEntries([Ljava/lang/CharSequence;)V

    .line 282
    iget-object v9, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mLocalePreference:Landroid/support/v7/preference/ListPreference;

    invoke-virtual {v9, v5}, Landroid/support/v7/preference/ListPreference;->setEntryValues([Ljava/lang/CharSequence;)V
...
.method private updateLanguageTo(Ljava/util/Locale;)V
    ...
    .local v0, "i":I
    :goto_1
    iget-object v3, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mLocalePreference:Landroid/support/v7/preference/ListPreference;
    ...
    iget-object v4, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mLocalePreference:Landroid/support/v7/preference/ListPreference;
...
.method private updateVoiceDetails(Landroid/content/Intent;)V
    ...
    .line 222
    iget-object v2, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mInstallVoicesPreference:Landroid/support/v7/preference/Preference;
    ...
    .line 229
    iget-object v2, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mLocalePreference:Landroid/support/v7/preference/ListPreference;

    invoke-virtual {v2, v4}, Landroid/support/v7/preference/ListPreference;->setEnabled(Z)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 113
    invoke-virtual {p0}, Lcom/android/settings/tts/TtsEngineSettingsFragment;->getPreferenceScreen()Landroid/support/v7/preference/PreferenceScreen;
    ...
    iput-object v4, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mLocalePreference:Landroid/support/v7/preference/ListPreference;
    ...
    iput-object v4, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mEngineSettingsPreference:Landroid/support/v7/preference/Preference;

    .line 117
    iget-object v4, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mEngineSettingsPreference:Landroid/support/v7/preference/Preference;
    ...
    iput-object v4, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mInstallVoicesPreference:Landroid/support/v7/preference/Preference;

    .line 119
    iget-object v4, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mInstallVoicesPreference:Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual {v4, v7}, Landroid/support/v7/preference/ListPreference;->setEnabled(Z)V
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/preference/ListPreference;->setEntries([Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/preference/ListPreference;->setEntryValues([Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v4, v1}, Landroid/support/v7/preference/ListPreference;->setEntryValues([Ljava/lang/CharSequence;)V

    .line 148
    iget-object v8, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mLocalePreference:Landroid/support/v7/preference/ListPreference;
    ...
    :goto_1
    invoke-virtual {v8, v4}, Landroid/support/v7/preference/ListPreference;->setValue(Ljava/lang/String;)V

    .line 149
    iget-object v5, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mLocalePreference:Landroid/support/v7/preference/ListPreference;
    ...
    :goto_2
    invoke-virtual {v5, v4}, Landroid/support/v7/preference/ListPreference;->setEnabled(Z)V
...
.method public onPreferenceClick(Landroid/support/v7/preference/Preference;)Z
    ...
    .line 316
    iget-object v0, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mInstallVoicesPreference:Landroid/support/v7/preference/Preference;
    ...
    .line 319
    :cond_0
    iget-object v0, p0, Lcom/android/settings/tts/TtsEngineSettingsFragment;->mEngineSettingsPreference:Landroid/support/v7/preference/Preference;
