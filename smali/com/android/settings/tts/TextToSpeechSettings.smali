...
.method private initSettings()V
    ...
    iput v6, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mDefaultRate:I
    ...
    iput v6, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mDefaultPitch:I

    .line 268
    iget-object v6, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mDefaultRatePref:Lcom/android/settings/SeekBarPreference;

    const-string/jumbo v7, "tts_default_rate"

    iget v8, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mDefaultRate:I

    invoke-direct {p0, v7, v8}, Lcom/android/settings/tts/TextToSpeechSettings;->getSeekBarProgressFromValue(Ljava/lang/String;I)I

    move-result v7

    invoke-virtual {v6, v7}, Lcom/android/settings/SeekBarPreference;->setProgress(I)V

    .line 269
    iget-object v6, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mDefaultRatePref:Lcom/android/settings/SeekBarPreference;

    invoke-virtual {v6, p0}, Lcom/android/settings/SeekBarPreference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V
    ...
    .line 272
    iget-object v6, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mDefaultPitchPref:Lcom/android/settings/SeekBarPreference;
    ...
    iput-object v6, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mCurrentEngine:Ljava/lang/String;

    .line 280
    iget-object v6, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mTts:Landroid/speech/tts/TextToSpeech;

    iget v7, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mDefaultRate:I
    ...
    iget v7, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mDefaultPitch:I
    ...
    .line 292
    .local v0, "activity":Lcom/android/settings/SettingsActivity;
    iget-object v6, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mEnginePreferenceCategory:Landroid/support/v7/preference/PreferenceCategory;
    ...
    invoke-virtual {p0}, Lcom/android/settings/tts/TextToSpeechSettings;->getPrefContext()Landroid/content/Context;

    move-result-object v6

    invoke-direct {v3, v6, v1, p0, v0}, Lcom/android/settings/tts/TtsEnginePreference;-><init>(Landroid/content/Context;Landroid/speech/tts/TextToSpeech$EngineInfo;Lcom/android/settings/tts/TtsEnginePreference$RadioButtonGroupState;Lcom/android/settings/SettingsActivity;)V
    ...
    :cond_2
    iget-object v6, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mCurrentEngine:Ljava/lang/String;

    invoke-direct {p0, v6}, Lcom/android/settings/tts/TextToSpeechSettings;->checkVoiceData(Ljava/lang/String;)V
...
.method private onVoiceDataIntegrityCheckDone(Landroid/content/Intent;)V
    ...
    .line 719
    :cond_3
    iget-object v5, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mEnginePreferenceCategory:Landroid/support/v7/preference/PreferenceCategory;
...
.method private updateEngineStatus(I)V
    ...
    .line 603
    :cond_0
    iget-object v1, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mEngineStatus:Landroid/support/v7/preference/Preference;
...
.method private updateWidgetState(Z)V
    ...
    .prologue
    .line 593
    iget-object v0, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mPlayExample:Landroid/support/v7/preference/Preference;
    ...
    .line 595
    iget-object v0, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mEngineStatus:Landroid/support/v7/preference/Preference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mPlayExample:Landroid/support/v7/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mResetSpeechRate:Landroid/support/v7/preference/Preference;

    .line 196
    iget-object v0, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mResetSpeechRate:Landroid/support/v7/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mResetSpeechPitch:Landroid/support/v7/preference/Preference;

    .line 198
    iget-object v0, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mResetSpeechPitch:Landroid/support/v7/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mEnginePreferenceCategory:Landroid/support/v7/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mEngineStatus:Landroid/support/v7/preference/Preference;
...
.method public onPreferenceClick(Landroid/support/v7/preference/Preference;)Z
    ...
    .line 539
    iget-object v2, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mPlayExample:Landroid/support/v7/preference/Preference;
    ...
    .line 544
    :cond_0
    iget-object v2, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mResetSpeechRate:Landroid/support/v7/preference/Preference;
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mResetSpeechPitch:Landroid/support/v7/preference/Preference;
