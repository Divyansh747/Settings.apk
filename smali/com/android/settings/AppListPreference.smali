...
# direct methods
.method static synthetic -get0(Lcom/android/settings/AppListPreference;)[Ljava/lang/CharSequence;
    .locals 1
...
.method static synthetic -get1(Lcom/android/settings/AppListPreference;)I
    .locals 1
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 66
    iput v3, p0, Lcom/android/settings/AppListPreference;->mType:I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .prologue
    .line 263
    instance-of v4, p1, Lcom/android/settings/AppListPreference$SavedState;
    ...
    .line 264
    check-cast v3, Lcom/android/settings/AppListPreference$SavedState;

    .line 265
    .local v3, "savedState":Lcom/android/settings/AppListPreference$SavedState;
    iget-boolean v4, v3, Lcom/android/settings/AppListPreference$SavedState;->showItemNone:Z

    iput-boolean v4, p0, Lcom/android/settings/AppListPreference;->mShowItemNone:Z

    .line 266
    iget v4, p0, Lcom/android/settings/AppListPreference;->mType:I

    if-nez v4, :cond_1

    .line 267
    iget-object v4, v3, Lcom/android/settings/AppListPreference$SavedState;->entryValues:[Ljava/lang/CharSequence;

    iget-object v5, v3, Lcom/android/settings/AppListPreference$SavedState;->value:Ljava/lang/CharSequence;

    invoke-virtual {p0, v4, v5}, Lcom/android/settings/AppListPreference;->setPackageNames([Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V

    .line 278
    :cond_0
    :goto_0
    iget-object v4, v3, Lcom/android/settings/AppListPreference$SavedState;->summaries:[Ljava/lang/CharSequence;

    iput-object v4, p0, Lcom/android/settings/AppListPreference;->mSummaries:[Ljava/lang/CharSequence;

    .line 279
    iget-object v4, v3, Lcom/android/settings/AppListPreference$SavedState;->superState:Landroid/os/Parcelable;

    invoke-super {p0, v4}, Lcom/android/settings/CustomListPreference;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    .line 262
    .end local v3    # "savedState":Lcom/android/settings/AppListPreference$SavedState;
    :goto_1
    return-void

    .line 268
    .restart local v3    # "savedState":Lcom/android/settings/AppListPreference$SavedState;
    :cond_1
    iget v4, p0, Lcom/android/settings/AppListPreference;->mType:I
    ...
    iget-object v5, v3, Lcom/android/settings/AppListPreference$SavedState;->entryValues:[Ljava/lang/CharSequence;
    ...
    .line 275
    invoke-virtual {p0, v0, v4}, Lcom/android/settings/AppListPreference;->setComponentNames([Landroid/content/ComponentName;Landroid/content/ComponentName;)V
...
.method public setComponentNames([Landroid/content/ComponentName;Landroid/content/ComponentName;[Ljava/lang/CharSequence;)V
    ...
    iput v10, p0, Lcom/android/settings/AppListPreference;->mType:I
...
.method public setPackageNames([Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    iput v9, p0, Lcom/android/settings/AppListPreference;->mSystemAppIndex:I
    ...
    .line 153
    iget v10, p0, Lcom/android/settings/AppListPreference;->mUserId:I
    ...
    .line 163
    iput v5, p0, Lcom/android/settings/AppListPreference;->mSystemAppIndex:I
    :try_end_0
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings/AppListPreference;->setValue(Ljava/lang/String;)V
