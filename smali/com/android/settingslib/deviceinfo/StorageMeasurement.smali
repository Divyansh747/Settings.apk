...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settingslib/deviceinfo/StorageMeasurement$MainHandler;,
        Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementDetails;,
        Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementHandler;,
        Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementReceiver;,
        Lcom/android/settingslib/deviceinfo/StorageMeasurement$StatsObserver;
    }
.end annotation
...
.field private final mMainHandler:Lcom/android/settingslib/deviceinfo/StorageMeasurement$MainHandler;

.field private final mMeasurementHandler:Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementHandler;
...
# direct methods
.method static synthetic -get0(Lcom/android/settingslib/deviceinfo/StorageMeasurement;)Landroid/content/Context;
    .locals 1
...
.method static synthetic -get1(Lcom/android/settingslib/deviceinfo/StorageMeasurement;)Lcom/android/settingslib/deviceinfo/StorageMeasurement$MainHandler;
    .locals 1

    iget-object v0, p0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->mMainHandler:Lcom/android/settingslib/deviceinfo/StorageMeasurement$MainHandler;

    return-object v0
.end method

.method static synthetic -get2(Lcom/android/settingslib/deviceinfo/StorageMeasurement;)Ljava/lang/ref/WeakReference;
    .locals 1
...
.method static synthetic -wrap0(Landroid/util/SparseLongArray;IJ)V
    ...
    .prologue
    invoke-static {p0, p1, p2, p3}, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->addValueIfKeyExists(Landroid/util/SparseLongArray;IJ)V
...
.method static synthetic -wrap1(Landroid/util/SparseLongArray;IJ)V
    ...
    .prologue
    invoke-static {p0, p1, p2, p3}, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->addValue(Landroid/util/SparseLongArray;IJ)V

    return-void
.end method

.method static synthetic -wrap2(Lcom/android/settingslib/deviceinfo/StorageMeasurement;Lcom/android/internal/app/IMediaContainerService;)V
    .locals 0
    .param p1, "imcs"    # Lcom/android/internal/app/IMediaContainerService;

    .prologue
    invoke-direct {p0, p1}, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->measureExactStorage(Lcom/android/internal/app/IMediaContainerService;)V
...
.method static constructor <clinit>()V
    ...
    .line 64
    sput-boolean v3, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->LOGV:Z
    ...
    sput-object v0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->sMeasureMediaTypes:Ljava/util/Set;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/storage/VolumeInfo;Landroid/os/storage/VolumeInfo;)V
    ...
    iput-object v1, p0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->mContext:Landroid/content/Context;
    ...
    .line 162
    new-instance v1, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MainHandler;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MainHandler;-><init>(Lcom/android/settingslib/deviceinfo/StorageMeasurement;Lcom/android/settingslib/deviceinfo/StorageMeasurement$MainHandler;)V

    iput-object v1, p0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->mMainHandler:Lcom/android/settingslib/deviceinfo/StorageMeasurement$MainHandler;

    .line 163
    new-instance v1, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementHandler;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v2

    invoke-direct {v1, p0, v2}, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementHandler;-><init>(Lcom/android/settingslib/deviceinfo/StorageMeasurement;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->mMeasurementHandler:Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementHandler;
...
.method private static getDirectorySize(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    ...
    .line 445
    .local v2, "size":J
    sget-boolean v1, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->LOGV:Z
...
.method private invalidate()V
    ...
    .prologue
    .line 190
    iget-object v0, p0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->mMeasurementHandler:Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementHandler;

    const/4 v1, 0x5

    invoke-virtual {v0, v1}, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementHandler;->sendEmptyMessage(I)Z
...
.method private measureExactStorage(Lcom/android/internal/app/IMediaContainerService;)V
    ...
    iget-object v5, v0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->mContext:Landroid/content/Context;
    ...
    new-instance v6, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementDetails;

    invoke-direct {v6}, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementDetails;-><init>()V

    .line 365
    .local v6, "details":Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementDetails;
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->mMeasurementHandler:Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementHandler;

    const/4 v7, 0x4

    invoke-virtual {v5, v7, v6}, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget-object v5, v0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->mVolume:Landroid/os/storage/VolumeInfo;
    ...
    iget-object v5, v0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->mSharedVolume:Landroid/os/storage/VolumeInfo;
    ...
    sget-object v5, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->sMeasureMediaTypes:Ljava/util/Set;
    ...
    iget-object v5, v6, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementDetails;->mediaSize:Landroid/util/SparseArray;
    ...
    invoke-static {v0, v1}, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->getDirectorySize(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    ...
    :cond_1
    iget-object v5, v6, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementDetails;->miscSize:Landroid/util/SparseLongArray;

    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v0, v1, v14}, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->measureMisc(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    ...
    invoke-static {v5, v0, v1, v2}, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->addValue(Landroid/util/SparseLongArray;IJ)V
    ...
    iget-object v5, v6, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementDetails;->usersSize:Landroid/util/SparseLongArray;
    ...
    invoke-static {v5, v7, v0, v1}, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->addValue(Landroid/util/SparseLongArray;IJ)V
    ...
    iput-wide v0, v6, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementDetails;->totalSize:J
    ...
    iput-wide v0, v6, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementDetails;->availSize:J
    ...
    iget-object v7, v0, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->mVolume:Landroid/os/storage/VolumeInfo;
    ...
    .line 428
    :cond_7
    new-instance v4, Lcom/android/settingslib/deviceinfo/StorageMeasurement$StatsObserver;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/android/settingslib/deviceinfo/StorageMeasurement$StatsObserver;-><init>(ZLcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementDetails;ILjava/util/List;Landroid/os/Message;I)V

    .line 430
    .local v4, "observer":Lcom/android/settingslib/deviceinfo/StorageMeasurement$StatsObserver;
    invoke-interface/range {v30 .. v30}, Ljava/lang/Iterable;->iterator()Ljava/util/Iterator;
    ...
    .line 437
    .end local v4    # "observer":Lcom/android/settingslib/deviceinfo/StorageMeasurement$StatsObserver;
    ...
    .line 356
    .restart local v4    # "observer":Lcom/android/settingslib/deviceinfo/StorageMeasurement$StatsObserver;
...
.method private measureMisc(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    ...
    sget-object v7, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->sMeasureMediaTypes:Ljava/util/Set;
    ...
    .line 468
    invoke-static {p1, v0}, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->getDirectorySize(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
...
.method public forceMeasure()V
    ...
    .prologue
    .line 173
    invoke-direct {p0}, Lcom/android/settingslib/deviceinfo/StorageMeasurement;->invalidate()V
...
.method public measure()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settingslib/deviceinfo/StorageMeasurement$MeasurementHandler;->hasMessages(I)Z
